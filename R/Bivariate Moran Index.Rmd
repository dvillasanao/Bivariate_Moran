...
![](../Output/Mapa%20del%20ICE%20a%20nivel%20municipal.png){width="70%" fig-align="center"} \   
...
```{r, fig.height=6, fig.width=8, eval = FALSE, class.source = "fold-hide", eval = FALSE}
p <-  ggplot() +
...
```{r, echo = FALSE}
require(gt)
tabla <- read.xlsx(xlsxFile = paste0("Output/clusters_municipal.xlsx")) %>% 
          group_by(cluster_IM) %>% 
           summarise(Municipios = n())
tabla %>% 
 gt() %>% 
  tab_header(title = "LISA: Local Moran's I (Clusters)",
             subtitle = md("Índice de Calidad del entorno, \n Índice de marginación a nivel municipal")) %>%
   tab_options(heading.title.font.size = 14, 
    ...
    cols_label(cluster_IM = md("**Cluster**"),
               Municipios = md("**Municipios**"))
```


![](../Output/Mapa%20LISA%20Cluster_IM.png){width="70%" fig-align="center"}
 ...
 gt() %>% 
  tab_header(title = "LISA: Local Moran's I (Clusters)",
   ...
   tab_options(heading.title.font.size = 14, 
    ...
    tab_style(style = list(cell_text(align = "left")),       
              locations = list(cells_title(groups = c("subtitle")))) %>%
    cols_label(cluster_IE = md("**Cluster**"),
               Municipios = md("**Municipios**"))
```

![](../Output/Mapa%20LISA%20Cluster_IE.png){width="80%" fig-align="center"}
 ...
 gt() %>% 
  tab_header(title = "LISA: Local Moran's I (Clusters)",
   ...
   tab_options(heading.title.font.size = 14, 
    ...
    tab_style(style = list(cell_text(align = "left")),       
              locations = list(cells_title(groups = c("subtitle")))) %>%
    cols_label(cluster_IAL = md("**Cluster**"),
               Municipios = md("**Municipios**"))
```

![](../Output/Mapa%20LISA%20Cluster_IAL.png){width="70%" fig-align="center"}
